                                            ...
                                            <fieldset class="row scheduler-border">
                                                ...
                                                <div class="form-group col-md-4">
                                                    ...
                                                    <select class="form-control" name="type_ide " id="type_ide " required>
                                                        ...
                                                        <option value="1"
                                                            @if (old('type_ide ') == 1) selected @endif>
                                                            Cédula de Ciudadania</option>
                                                        <option value="2"
                                                            @if (old('type_ide ') == 2) selected @endif>
                                                            Cédula de extranjería</option>
                                                        <option value="3"
                                                            @if (old('type_ide ') == 3) selected @endif>
                                                            Pasaporte</option>
                                                        <option value="3"
                                                            @if (old('type_ide ') == 4) selected @endif>
                                                ...
                                                <div class="form-group col-md-4">
                                                    ...
                                                    <select class="form-control" name="economic_stratum "
                                                        ...
                                                        <option value="1"
                                                            ...
                                                            {{ __('1') }}</option>
                                                        <option value="2"
                                                            @if (old('economic_stratum ') == 2) selected @endif>
                                                            {{ __('2') }}</option>
                                                        <option value="3"
                                                            @if (old('economic_stratum ') == 3) selected @endif>
                                                            {{ __('3') }}</option>
                                                        <option value="4"
                                                            @if (old('economic_stratum ') == 4) selected @endif>
                                                            {{ __('4') }}</option>
                                                        <option value="5"
                                                            @if (old('economic_stratum ') == 5) selected @endif>
                                                            {{ __('5') }}</option>
                                                        <option value="6"
                                                            @if (old('economic_stratum ') == 6) selected @endif>
                                                            {{ __('6') }}</option>
                                                        <option value="7"
                                                            @if (old('economic_stratum ') == 7) selected @endif>
                                                            {{ __('No aplica') }}</option>
                                                    ...
                                                    <div class="col-md-12">
                                                        <fieldset class="row scheduler-border">
                                                            ...
                                                            <div class="form-group col-md-12">
                                                                <label
                                                                    for="present_address">{{ __('field_address') }}</label>
                                ...
                                <content class="form-step">
                                    ...
                                    <fieldset class="row scheduler-border">
                                        ...
                                        <div class="form-group col-md-4">
                                            ...
                                            <input type="text" class="form-control autonumber" name="bank_account_no"
                                                id="bank_account_no" value="{{ old('bank_account_no') }}">
