            ...
            <div class="modal-content">
              <form class="needs-validation" novalidate action="{{ route($route.'.update', $row->id) }}" method="post" enctype="multipart/form-data">
                ...
                <div class="modal-body">
                    ...
                    <div class="form-group">
                        <label for="jornada">{{ __('field_jornada') }} <span>*</span></label>
                        <select class="form-control" name="jornada" id="jornada" required>
                            <option value="">{{ __('select') }}</option>
                            <option value="Diurna" @if( $row->jornada == 'Diurna' ) selected @endif>Diurna</option>
                            <option value="Nocturna" @if( $row->jornada == 'Nocturna' ) selected @endif>Nocturna</option>
                        </select>

                        <div class="invalid-feedback">
                          {{ __('required_field') }} {{ __('field_jornada') }}
                        </div>
                    </div>
