                            ...
                            <form id="wizard-advanced-form" class="needs-validation" novalidate
                                ...
                                <content class="form-step">
                                    ...
                                    {{-- <div class="row" style="display: none">
                                      <div class="col-md-12">
                                        <fieldset class="row scheduler-border">
                                            <legend>{{ __('INFORMACIÓN DE PADRES O TUTORES')}}</legend>
                                            <div class="form-group col-md-6">
                                ...
                                <content class="form-step">
                                    ...
                                    <fieldset class="row scheduler-border">
                                        ...
                                        <div class="form-group col-md-3" style="display:none">
                                            ...
                                            <input type="text" value="sin valor" class="form-control"
                                                name="school_exam_id" id="school_exam_id"
                                                value="{{ old('school_exam_id') }}">
                                        ...
                                        <div class="form-group col-md-3">
                                            ...
                                            <input type="text" class="form-control" name="school_graduation_year"
                                                id="school_graduation_year" value="{{ old('school_graduation_year') }}">
                                        ...
                                        <div class="form-group col-md-3" style="display:none">
                                            ...
                                            <input type="text" value="sin valor" class="form-control"
                                                name="school_graduation_point" id="school_graduation_point"
                                    ...
                                    <fieldset class="row scheduler-border">
                                        ...
                                        <div class="form-group col-md-3" style="display:none">
                                            ...
                                            <input type="text" value="sin valor" class="form-control"
                                                name="collage_exam_id" id="collage_exam_id"
                                                value="{{ old('collage_exam_id') }}">
                                    ...
                                    <fieldset class="row scheduler-border" >
                                        ...
                                        <div class="container-fluid">
                                            <div id="inputFormField" class="row">
                                                ...
                                                <div class="form-group col-md-4">
                                                    <label for="relation" class="form-label">{{ __('field_relation') }}
                                                        <span>*</span></label>
                                                ...
                                                <div class="form-group col-md-4">
                                                    <label for="relative_name" class="form-label">{{ __('field_name') }}
                                                        <span>*</span></label>
                                                    <input type="text" class="form-control" name="relative_names[]"
                                                        id="relative_name" value="{{ old('relative_name') }}" required>
                                                ...
                                                <div class="form-group col-md-4">
                                                    <label for="relative_phone"
                                                        class="form-label">{{ __('field_phone') }} <span>*</span></label>
                                                    <input type="text" class="form-control" name="relative_phones[]"
                                                        id="relative_phone" value="{{ old('relative_phone') }}"
                                                        required>
                                                ...
                                                <div class="form-group col-md-4">
                                                    <label for="address" class="form-label">{{ __('field_address') }}
                                                        <span>*</span></label>
                                                ...
                                                <div class="form-group col-md-4" >
                                                    <button id="removeField" type="button"
                                                        class="btn btn-danger btn-filter"><i class="fas fa-trash-alt"></i>
