...
class User extends Authenticatable
{
     ...
     */
    protected $fillable = [
        'staff_id', 'department_id', 'designation_id', 'first_name', 'last_name', 'email', 'password', 'password_text', 'gender', 'dob', 'phone', 'religion', 'caste', 'mother_tongue', 'marital_status', 'blood_group', 'nationality', 'national_id', 'passport_no', 'country', 'present_province', 'present_district', 'present_village', 'present_address', 'permanent_province', 'permanent_district', 'permanent_village', 'education_level', 'graduation_academy', 'year_of_graduation', 'graduation_field', 'experience', 'note', 'basic_salary', 'contract_type', 'work_shift', 'salary_type', 'epf_no', 'bank_account_name', 'bank_account_no', 'bank_name', 'ifsc_code', 'bank_brach', 'tin_no', 'photo', 'signature', 'resume', 'joining_letter', 'is_admin', 'login', 'status', 'created_by', 'updated_by',
        'type_ide','second_last_name','second_first_name','expedition_date','place_of_birth','expiration_date','economic_stratum','institutional_e_mail','eps','habeas_data','town_of_birth','place_of_residence','residence_address','neighborhood','country_code','area_code'
